...
databaseChangeLog(logicalFilePath: 'script/db/hrpt_report.groovy') {
    changeSet(author: "hzero@hand-china.com", id: "2019-02-19-hrpt_report") {
        ...
        createTable(tableName: "hrpt_report", remarks: "报表信息") {
            column(name: "report_id", type: "bigint(20)", autoIncrement: true ,   remarks: "表ID，主键，供其他表做外键")  {constraints(primaryKey: true)} 
            ...
            column(name: "dataset_id", type: "bigint(20)",  remarks: "数据集，hrpt_dataset.dataset_id")  {constraints(nullable:"false")}  
            ...
            column(name: "page_flag", type: "tinyint(1)",   defaultValue:"0",   remarks: "分页标识，0:不分页 1:分页")  {constraints(nullable:"false")}  
            column(name: "limit_rows", type: "int(11)",   defaultValue:"20",   remarks: "每页条数")  {constraints(nullable:"false")}  
