...
databaseChangeLog(logicalFilePath: 'script/db/hrpt_report_permission.groovy') {
    changeSet(author: "hzero@hand-china.com", id: "2019-02-19-hrpt_report_permission") {
        ...
        createTable(tableName: "hrpt_report_permission", remarks: "报表权限") {
            ...
            column(name: "report_id", type: "bigint(20)",  remarks: "报表类别，hrpt_report.report_id")  {constraints(nullable:"false")}  
            column(name: "tenant_id", type: "bigint(20)",   defaultValue:"0",   remarks: "租户ID,hpfm_tenant.tenant_id")  {constraints(nullable:"false")}  
            column(name: "role_id", type: "bigint(20)",   defaultValue:"0",   remarks: "角色ID，iam_role.role_id")   
