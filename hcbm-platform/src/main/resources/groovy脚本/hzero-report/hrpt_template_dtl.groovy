...
databaseChangeLog(logicalFilePath: 'script/db/hrpt_template_dtl.groovy') {
    changeSet(author: "hzero@hand-china.com", id: "2019-02-19-hrpt_template_dtl") {
        ...
        createTable(tableName: "hrpt_template_dtl", remarks: "报表模板明细") {
            column(name: "template_dtl_id", type: "bigint(20)", autoIncrement: true ,   remarks: "表ID，主键，供其他表做外键")  {constraints(primaryKey: true)} 
            column(name: "template_id", type: "bigint(20)",  remarks: "报表模板ID,hrpt_template.template_id")  {constraints(nullable:"false")}  
