...
databaseChangeLog(logicalFilePath: 'script/db/hrpt_report_template.groovy') {
    changeSet(author: "hzero@hand-china.com", id: "2019-02-19-hrpt_report_template") {
        ...
        createTable(tableName: "hrpt_report_template", remarks: "报表模板关系") {
            column(name: "report_template_id", type: "bigint(20)", autoIncrement: true ,   remarks: "表ID，主键，供其他表做外键")  {constraints(primaryKey: true)} 
            column(name: "report_id", type: "bigint(20)",  remarks: "报表ID，hrpt_report.report_id")   
            column(name: "template_id", type: "bigint(20)",  remarks: "报表模板ID，hrpt_template.template_id")   
