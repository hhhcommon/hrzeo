...
databaseChangeLog(logicalFilePath: 'script/db/hitf_server_assign.groovy') {
    changeSet(author: "shuangfei.zhu@hand-china.com", id: "2019-02-28-hitf_server_assign") {
        ...
        createTable(tableName: "hitf_server_assign", remarks: "应用与服务关联") {
            column(name: "assign_id", type: "bigint(20)", autoIncrement: true ,   remarks: "表ID，主键，供其他表做外键主键")  {constraints(primaryKey: true)} 
            column(name: "application_id", type: "bigint(20)",  remarks: "应用ID，hitf_application.application_id")  {constraints(nullable:"false")}  
            column(name: "interface_server_id", type: "bigint(20)",  remarks: "服务ID，hitf_interface_server.interface_server_id")  {constraints(nullable:"false")}  
