...
databaseChangeLog(logicalFilePath: 'script/db/himp_template_line.groovy') {
    changeSet(author: "hzero@hand-china.com", id: "2019-02-19-himp_template_line") {
        ...
        createTable(tableName: "himp_template_line", remarks: "通用模板行") {
            ...
            column(name: "target_id", type: "bigint(20)",  remarks: "模板目标ID,himp_template_target.id")  {constraints(nullable:"false")}  
            column(name: "column_index", type: "int(11)",  remarks: "列序号")  {constraints(nullable:"false")}  
            ...
            column(name: "length", type: "bigint(20)",  remarks: "列长度")   
            column(name: "format_mask", type: "varchar(" + 20 * weight + ")",  remarks: "列值格式掩码")   
            column(name: "enabled_flag", type: "tinyint(1)",   defaultValue:"1",   remarks: "是否有效")  {constraints(nullable:"false")}  
            column(name: "nullable_flag", type: "tinyint(1)",   defaultValue:"0",   remarks: "必输验证标识")  {constraints(nullable:"false")}  
            column(name: "validate_flag", type: "tinyint(1)",   defaultValue:"0",   remarks: "验证标识")  {constraints(nullable:"false")}  
            column(name: "change_data_flag", type: "tinyint(1)",   defaultValue:"0",   remarks: "是否开启数据转换")  {constraints(nullable:"false")}  
