...
databaseChangeLog(logicalFilePath: 'script/db/hsdr_conc_request.groovy') {
    changeSet(author: "shuangfei.zhu@hand-china.com", id: "2019-02-18-hsdr_conc_request") {
        ...
        createTable(tableName: "hsdr_conc_request", remarks: "并发请求") {
            column(name: "request_id", type: "bigint(20)", autoIncrement: true ,   remarks: "表ID，主键，供其他表做外键")  {constraints(primaryKey: true)} 
            column(name: "concurrent_id", type: "bigint(20)",  remarks: "并发程序ID,hsdr_concurrent.concurrent_id")  {constraints(nullable:"false")}  
            column(name: "executable_id", type: "bigint(20)",  remarks: "并发可执行ID,hsdr_conc_executable.executable_id")  {constraints(nullable:"false")}  
            column(name: "cycle_flag", type: "tinyint(1)",   defaultValue:"0",   remarks: "周期性")  {constraints(nullable:"false")}  
            column(name: "interval_type", type: "varchar(" + 30 * weight + ")",  remarks: "间隔类型，HSDR.REQUEST.INTERVAL_TYPE(天/时/分/秒)")   
            column(name: "interval_number", type: "int(11)",  remarks: "间隔大小")   
            column(name: "interval_hour", type: "int(11)",  remarks: "固定间隔-时")   
            column(name: "interval_minute", type: "int(11)",  remarks: "固定间隔-分")   
            column(name: "interval_second", type: "int(11)",  remarks: "固定间隔-秒")   
            ...
            column(name: "job_id", type: "bigint(20)",  remarks: "任务ID，hsdr_job_info.job_id")   
