...
databaseChangeLog(logicalFilePath: 'script/db/hsdr_conc_param.groovy') {
    changeSet(author: "shuangfei.zhu@hand-china.com", id: "2019-02-18-hsdr_conc_param") {
        ...
        createTable(tableName: "hsdr_conc_param", remarks: "并发程序参数") {
            column(name: "conc_param_id", type: "bigint(20)", autoIncrement: true ,   remarks: "表ID，主键，供其他表做外键")  {constraints(primaryKey: true)} 
            ...
            column(name: "notnull_flag", type: "tinyint(1)",   defaultValue:"0",   remarks: "是否必须")  {constraints(nullable:"false")}  
            ...
            column(name: "show_flag", type: "tinyint(1)",   defaultValue:"1",   remarks: "是否展示")  {constraints(nullable:"false")}  
