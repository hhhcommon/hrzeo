...
databaseChangeLog(logicalFilePath: 'script/db/hsdr_conc_permission.groovy') {
    changeSet(author: "shuangfei.zhu@hand-china.com", id: "2019-02-18-hsdr_conc_permission") {
        ...
        createTable(tableName: "hsdr_conc_permission", remarks: "并发请求权限") {
            column(name: "permission_id", type: "bigint(20)", autoIncrement: true ,   remarks: "表ID，主键，供其他表做外键")  {constraints(primaryKey: true)} 
            column(name: "concurrent_id", type: "bigint(20)",  remarks: "并发程序ID,hsdr_conc_pragram.concurrent_id")  {constraints(nullable:"false")}  
            column(name: "limit_quantity", type: "int(11)",  remarks: "限制次数")   
            column(name: "role_id", type: "bigint(20)",  remarks: "角色ID，iam_role.role_id")  {constraints(nullable:"false")}  
