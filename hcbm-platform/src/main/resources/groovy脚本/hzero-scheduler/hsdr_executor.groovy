...
databaseChangeLog(logicalFilePath: 'script/db/hsdr_executor.groovy') {
    changeSet(author: "shuangfei.zhu@hand-china.com", id: "2019-02-18-hsdr_executor") {
        ...
        createTable(tableName: "hsdr_executor", remarks: "执行器") {
            column(name: "executor_id", type: "bigint(20)", autoIncrement: true ,   remarks: "表ID，主键，供其他表做外键")  {constraints(primaryKey: true)} 
            ...
            column(name: "order_seq", type: "int(11)",   defaultValue:"0",   remarks: "排序")  {constraints(nullable:"false")}  
            column(name: "executor_type", type: "tinyint(1)",   defaultValue:"0",   remarks: "执行器地址类型：0=自动注册、1=手动录入")  {constraints(nullable:"false")}  
            ...
            column(name: "scope", type: "tinyint(1)",   defaultValue:"0",   remarks: "权限范围：0=租户级、1=平台级")  {constraints(nullable:"false")}  
