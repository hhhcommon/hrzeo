...
databaseChangeLog(logicalFilePath: 'script/db/hmsg_user_receive_config.groovy') {
    changeSet(author: "qingsheng.chen@hand-china.com", id: "2019-01-02-hmsg_user_receive_config") {
        ...
        createTable(tableName: "hmsg_user_receive_config", remarks: "用户接收配置") {
            column(name: "user_receive_id", type: "bigint(20)", autoIncrement: true ,   remarks: "表ID，主键，供其他表做外键")  {constraints(primaryKey: true)} 
            column(name: "user_id", type: "bigint(20)",  remarks: "用户id,iam_user.id")  {constraints(nullable:"false")}  
            column(name: "receive_code", type: "varchar(" + 30 * weight + ")",  remarks: "hmsg_receive_config .receiver_code")  {constraints(nullable:"false")}  
